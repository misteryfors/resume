...
async function pageLoadCity(city) {
  let apiUrl = `http://api.weatherapi.com/v1/forecast.json?key=6e40db2d40af4681bce15022242210&q=${encodeURIComponent(city)}&days=5&aqi=no&alerts=no`;
...
async function pageLoadGeo(latitude,longitude) {
    let apiUrl = `http://api.weatherapi.com/v1/forecast.json?key=6e40db2d40af4681bce15022242210&q=${latitude},${longitude}&days=5&aqi=no&alerts=no`;
