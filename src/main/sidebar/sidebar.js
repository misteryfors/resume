const sidebarData = {
    ...
    social: [
        { type: 'Вконтакте', icon: 'icons8-вконтакте.svg', details: '@id152716600', href: 'https://vk.com/id152716600' },
        { type: 'Telegram', icon: 'telegram.svg', details: '@mistfors', href: 'https://t.me/mistfors' },
        { type: 'Discord', icon: 'discord-icon-svgrepo-com.svg', details: 'mistfors#9294', href: '#' }
    ],
    lang: [
        { type: 'Русский', icon: 'ru.svg', details: 'Носитель', href: '' },
        { type: 'Английский', icon: 'gb.svg', details: 'Базовый', href: '' }
    ]
};
